 ...
 *
 * @returns {BubbleStyle[]} An array of bubble style objects.
 */
export const getBubbleStyles = (colors: string[]): BubbleStyle[] => [
  {
    id: 'bubble-1',
    color: colors[0],
    ...
    size: 'h-24 w-24',
    hoverTranslate:
      'group-hover:-translate-x-1 group-hover:translate-y-1 2xl:group-hover:-translate-x-2 2xl:group-hover:translate-y-2',
  },
  {
    id: 'bubble-2',
    color: colors[1],
