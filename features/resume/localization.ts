...
export const RESUME = {
  ...
  versionPDF: 'PDF',
  descriptionHighlightPDF: 'Nice visual design',
  descriptionPDF: '— with colors, icons, and custom layout.',
  downloadResumeShortPDF: 'Download PDF',
  versionDOCX: 'DOCX',
  descriptionHighlightDOCX: 'Simple ATS version',
  descriptionDOCX: '— clean text, no colors, no icons.',
  downloadResumeShortDOCX: 'Download DOCX',
  startingDownloadPDF: 'Started PDF download',
  startingDownloadDOCX: 'Started DOCX download',
