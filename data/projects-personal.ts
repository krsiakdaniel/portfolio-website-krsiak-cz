...
export const projectsPersonal: Project[] = [
  {
    ...
    linkText: 'Read more →',
    links: [{ urlText: 'Website →', url: 'https://krsiak.cz/' }],
  ...
  },
  {
    ...
    linkText: 'Read more →',
    links: [{ urlText: 'Website →', url: 'https://cryptomania-currency-prices.netlify.app/' }],
  ...
  },
  {
    ...
    linkText: 'Read more →',
    links: [{ urlText: 'Website →', url: 'https://ecommerce-vue-nuxt.onrender.com/' }],
