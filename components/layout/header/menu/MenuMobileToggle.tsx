...
const MenuMobileToggle: FC<MenuMobileToggleProps> = ({
  ...
  return (
    <button
      ...
      className="ml-6 rounded-lg bg-violet-50 p-2 transition-all duration-200 ease-in-out hover:bg-violet-100 focus:bg-violet-100 focus:outline-hidden focus:ring-4 focus:ring-violet-400 lg:hidden"
    >
