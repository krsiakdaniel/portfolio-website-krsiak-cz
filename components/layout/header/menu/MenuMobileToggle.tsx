...
const MenuMobileToggle: FC<MenuMobileToggleProps> = ({
  ...
  return (
    <button
      ...
      className="ml-8 rounded-lg bg-violet-50 p-2 hover:bg-violet-100 focus:bg-violet-100 focus:outline-none focus:ring-4 focus:ring-violet-400 lg:hidden transition-all duration-200 ease-in-out"
    >
