...
const ExpertiseSection = ({
  ...
  return (
    <div className="relative flex w-full flex-col rounded-lg border border-gray-200 bg-white px-4 py-6 transition-shadow duration-300 ease-in-out hover:border-gray-300 hover:shadow-md">
