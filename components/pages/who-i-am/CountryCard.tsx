...
const CountryCard = ({ country }: { country: TravelCountry }) => (
  <div className="flex items-center justify-between rounded-lg border border-gray-200 bg-white p-4 transition-shadow duration-300 ease-in-out select-none hover:border-gray-300 hover:shadow-md">
