    ...
    <div className="container mx-auto">
      <div className="pb-10">
        ...
        <div className="flex flex-col pt-5">
          ...
          <div>
            <p className="text-body-md font-normal text-neutral-700 pb-4">{rolesDescription}</p>
            <h3 className="text-display-xs font-semibold">{projectsHeading}</h3>
            <p className="text-body-md font-normal text-neutral-700 pb-4">{projectsDescription}</p>
          </div>
          <div className="flex flex-col">
            <div className="flex md:flex-row flex-col flex-wrap">{children}</div>
          </div>
        </div>
      </div>
    </div>
