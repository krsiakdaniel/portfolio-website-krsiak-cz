...
const JobItem = ({ path, title, description, years }: Props) => {
  return (
    <li className="mb-10 ms-6 last:mb-0">
      ...
      <h3 className="mb-1 flex flex-col items-start text-lg font-semibold text-neutral-900 lg:flex-row">
        {title}
      ...
      <p className="mb-4 text-base font-normal text-neutral-500 last:mb-0">{description}</p>
    </li>
  )
}
