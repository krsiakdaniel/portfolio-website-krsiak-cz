...
export const RESUME = {
  ...
  descriptionHighlightPDF: 'Print and read',
  descriptionPDF: 'version for paper.',
  altPreviewPDF: 'Resume PDF Preview',
  downloadResumeShortPDF: 'Download PDF',
  versionDOCX: 'DOCX Version',
  descriptionHighlightDOCX: 'Applicant Tracking Systems',
  descriptionDOCX: 'version.',
  altPreviewDOCX: 'Resume DOCX Preview',
