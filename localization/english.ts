...
export const RESUME = {
  ...
  downloadResumeShortTXT: 'Download TXT',
  altPreviewPDF: 'Resume PDF Preview',
  altPreviewTXT: 'Resume TXT Preview',
  versionPDF: 'PDF Version',
  versionTXT: 'TXT Version',
  descriptionTXT: 'version.',
  descriptionHighlightTXT: 'Applicant Tracking Systems',
