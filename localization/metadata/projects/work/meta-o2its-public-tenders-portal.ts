...
export const META_O2ITS_PUBLIC_TENDERS_PORTAL = {
  ...
  keywords: {
    ...
    materialUi: COMMON_VALUES.materialUi,
    reactHookForm: COMMON_VALUES.reactHookForm,
    zod: COMMON_VALUES.zod,
    graphQL: COMMON_VALUES.graphql,
    zustand: COMMON_VALUES.zustand,
    aiTools: COMMON_VALUES.aiTools,
